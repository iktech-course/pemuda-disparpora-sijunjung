...
<html>
	...
	<div class="row">
	 ...
	 <nav class="navbar navbar-dark" style="background-color: blue;">
          ...
          <li class="sidebar">
            <a class="sidebar" aria-current="page" href="beranda.html">Beranda</a>
          </li>
		  <li>
	...
	<table>
		...
		<td><?php echo $data["suku_bangsa"] ?></td>
		</tr>
		
		</table>
		</div>
	<div class="col-md-4">
	<img src="images/<?= $data['images']?>" alt="" style="width: 400px; height: 300px;">
    </div>
