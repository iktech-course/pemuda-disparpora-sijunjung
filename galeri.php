        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="#">Pemuda Berdasarkan Jenis Kelamin</a></li>
                <li><a class="dropdown-item" href="#">Pemuda Berdasrkan Pendidikan</a></li>
                <li><a class="dropdown-item" href="#">Pemuda Berdasarkan Pekerjaan</a></li>
                <hr class="dropdown-divider">
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="#">Pemuda Dalam Organisasi</a></li>
                <li><a class="dropdown-item" href="#">Pemuda Dalam Wirausaha</a></li>
                <hr class="dropdown-divider">
                </li>
              </ul>
            </li>
...
<h1 class="mt-4" style="font-family: serif; text-align: center;">Galeri</h1>
  <div class="container">
  <div class="row">
      <?php
    ...
    <div class="col mt-4">
    <img src="images/<?= $data['images']?>" alt="" style="width: 250px; height: 200px;">
    </div>
