        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- judul-->
                    <h3 style="text-align : center; font-family : serif;">Foto</h3>
                    <!-- Tabel-->
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#exampleModal1<?php echo $data["id_galeri"] ?>">
                                                    Edit
                                                </button>
                                                <a href="hapus-galery.php?id_galeri=<?= $data['id_galeri'] ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data?')">Hapus</a>
                                            </td>
                        </div>
                        <!--end modal-->
                                                                        <!-- Modal Edit Data -->
                                                                        <div class="modal fade" id="exampleModal1<?php echo $data["id_galeri"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <input name="id_galeri" placeholder="Id" value="<?php echo $data["id_galeri"] ?>" class="form-control" hidden>
                                                                ...
                                                                if (isset($_POST['update'])) {
                                                                    $id_galeri = mysqli_real_escape_string($koneksi, $_POST['id_galeri']);
                                                                    $judul = mysqli_real_escape_string($koneksi, $_POST['judul']);
                                                                    $dir = "images/";
                                                                    $file = $_FILES['namaGambar']['name'];
                                                                    move_uploaded_file($_FILES['namaGambar']['tmp_name'], $dir . $file);

                                                                    mysqli_query($koneksi, "UPDATE tb_galeri set judul='$judul',  images='$file' where id_galeri='$id_galeri'");
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        if (isset($_POST['proses'])) {
                                            ...
                                            mysqli_query($koneksi, "INSERT INTO tb_galeri (judul, images) VALUES ('$judul', '$file')");
