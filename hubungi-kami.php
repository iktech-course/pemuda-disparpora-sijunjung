...
<html>
	...
	<div class="row">
	 ...
	 <nav class="navbar navbar-dark" style="background-color: blue;">
		  ...
		  <a class="sidebar" href="#">Data Pemuda</a>
		  </li>
		  </ul>
		  </li>
		  <li>
		  ...
		  <a class="sidebar" href="karang taruna.php">Karang Taruna</a>
           ...
           <li class="sidebar">
            <a class="sidebar" href="loginfix.php">Login</a>
          </li>
        </ul>
          ...
          <div class="container mt-4">
            ...
            <?php 
                ...
                $id = $_GET['nik'];
                $query = mysqli_query($koneksi, "SELECT * FROM `tb_pemuda` WHERE NIK = '$id';");
            ...
            <input type="hidden" name="nik">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?= $data['TEMPAT LAHIR']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">TANGGAL LAHIR</label>
                    <input type="text" class="form-control" id="tanggal_lahir" name= "tanggal_lahir" value="<?= $data['TANGGAL LAHIR']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">JENIS KELAMIN</label>
                    <input type="text" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value="<?= $data['JENIS KELAMIN']?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="riwayat_organisasi" name ="riwayat_organisasi" value="<?= $data['RIWAYAT ORGANISASI']?>">
                </div>
