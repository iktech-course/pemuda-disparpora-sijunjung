...
<body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
        ...
        <input  name="asal_sekolah"  placeholder="Asal Sekolah" class="form-control" style="width: 50%"><br>
        <input  name="tinggi_badan"  placeholder="Tinggi Badan" class="form-control" style="width: 50%"><br>
        <input  name="berat_badan"  placeholder="Berat Badan" class="form-control" style="width: 50%"><br>
    ...
    <?php
        ...
        if(isset($_POST['proses']))
        {
            ...
            mysqli_query($koneksi,"INSERT INTO tb_paski (nama, alamat, asal_sekolah, no_hp, ttl, jenis_kelamin, berat_badan, tinggi_badan) VALUES ('$nama', '$alamat', '$asal_sekolah', '$no_hp', '$ttl', '$jenis_kelamin', '$berat_badan', '$tinggi_badan')");
