                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($koneksi, "SELECT * FROM organisasi_pemuda");
                                    $no = 0;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#exampleModal1<?php echo $data["id_organisasi"] ?>">
                                                    Edit
                                                </button>
                                                <a href="hapus-okp.php?id_organisasi=<?= $data['id_organisasi'] ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data?')">Hapus</a>
                                            </td>

                        </div>
                        <!--end modal-->
                                                                        <!-- Modal Edit Data -->
                                                                        <div class="modal fade" id="exampleModal1<?php echo $data["id_organisasi"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Data OKP</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                    <input name="nama" placeholder="Nama Kelompok Organisasi" value="<?php echo $data["nama"] ?>" class="form-control"><br>
                                                                    <input name="keterangan" placeholder="Keterangan" value="<?php echo $data["keterangan"] ?>" class="form-control"><br>
                                                                ...
                                                                if (isset($_POST['update'])) {
                                                                    $id_organisasi = mysqli_real_escape_string($koneksi, $_POST['id_organisasi']);
                                                                    $nama = mysqli_real_escape_string($koneksi, $_POST['nama']);
                                                                    $keterangan = mysqli_real_escape_string($koneksi, $_POST['keterangan']);
                                                    
                                                                       mysqli_query($koneksi, "UPDATE organisasi_pemuda set nama='$nama', keterangan='$keterangan' where id_organisasi='$id_organisasi'");
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <input name="NAMA" placeholder="NAMA KELOMPOK" class="form-control"><br>
                                            <input name="KETERANGAN" placeholder="KETERANGAN" class="form-control"><br>
                                        ...
                                        if (isset($_POST['proses'])) {
                                            ...
                                            mysqli_query($koneksi, "INSERT INTO organisasi_pemuda (nama, keterangan) VALUES ('$nama','$keterangan)");
