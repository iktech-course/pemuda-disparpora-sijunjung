            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#exampleModal1<?php echo $data["id_berita"] ?>">
                                                    Edit
                                                </button>
                        ...
                        <!--end modal-->
                                                                        <!-- Modal Edit Data -->
                                                                        <div class="modal fade" id="exampleModal1<?php echo $data["id_berita"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <input name="id_berita" placeholder="Id" value="<?php echo $data["id_berita"] ?>" class="form-control"><br>
                                                                    <input name="judul" placeholder="Judul" value="<?php echo $data["judul"] ?>" class="form-control"><br>
                                                                    <input name="deskripsi" value="<?php echo $data["deskripsi"] ?>" placeholder="Deskripsi" class="form-control"><br>
                                                                ...
                                                                if (isset($_POST['update'])) {
                                                                    $id_berita = mysqli_real_escape_string($koneksi, $_POST['id_berita']);
                                                                    ...
                                                                    mysqli_query($koneksi, "UPDATE tb_berita set judul='$judul', deskripsi='$deskripsi', images='$file' where id_berita='$id_berita'");
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <input name="judul" placeholder="Judul" class="form-control"><br>
                                        ...
                                        if (isset($_POST['proses'])) {
                                            ...
                                            mysqli_query($koneksi, "INSERT INTO tb_berita (judul, deskripsi, images) VALUES ('$judul', '$deskripsi', '$file')");
